...
land.addListener(function(l) {if (l.matches) {if (isTablet||isMobile) {Para.style.top = "120vh"}}else {Para.style.top = "75vh"}})
if (land.matches) {if (isTablet||isMobile) {Para.style.top = "120vh"}}else {Para.style.top = "75vh"}
...
function isTabletOrMobile(){
	if (isMobile||isTablet){
		...
		Pause.style.top ="11vh"
		//TouchStart.style.top = "60vh"
		Start.style.top = "37vh"
		Restart.style.top = "49vh"
		ControlMenu.style.top = "62vh"
