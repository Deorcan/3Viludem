...
land.addListener(function(l) {if (l.matches) {if (isTablet||isMobile) {Para.style.top = "120vh"}}else {Para.style.top = "70vh"}})
if (land.matches) {if (isTablet||isMobile) {Para.style.top = "120vh"}}else {Para.style.top = "70vh"}
